...
function Install-Assets {
    ...
    $files   = @("prompt.md", "sub-coordinator-prompt.md", "main-orchestrator-rules.md", "merge-recovery-prompt.md", "complexity-prompt.md", "review-prompt.md", "modifier-prompt.md", "coordinator-rules.md", "run-agent.sh", "run-agent.ps1", "run-with-it-dispatch.sh", "run-with-it-pool.sh", "worker-watch.sh", "agent-registry.json")
