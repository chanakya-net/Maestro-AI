...
assert_contains '3. `## Agent Routing`' "documents Agent Routing section order"
assert_contains '4. `## Technical Context Snapshot`' "documents Technical Context Snapshot section order"
assert_contains '5. `## Acceptance criteria`' "documents Acceptance criteria section order"
assert_contains '6. `## Blocked by`' "documents Blocked by section order"
