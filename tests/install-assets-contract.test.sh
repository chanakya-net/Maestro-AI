...
assert_contains "${dry_run_output}" "run-with-it-dispatch.ps1" "dry-run includes PowerShell run-with-it dispatcher asset"
assert_contains "${dry_run_output}" "run-with-it-pool.sh" "dry-run includes shared run-with-it pool asset"
assert_contains "${dry_run_output}" "run-with-it-pool.ps1" "dry-run includes PowerShell run-with-it pool asset"
assert_contains "${dry_run_output}" "worker-watch.sh" "dry-run includes worker watcher asset"
assert_contains "${dry_run_output}" "worker-watch.ps1" "dry-run includes PowerShell worker watcher asset"
